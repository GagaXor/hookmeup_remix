...
import {  Tabs, type TabsRef, Modal,  } from 'flowbite-react';
import { HiAdjustments,  HiUserCircle } from 'react-icons/hi';
import { MdDashboard } from 'react-icons/md';
import { useState, useRef } from "react";

export default function EscortProfile(data: any) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 col-span-2 ...">
            <div id="gallery" className="relative w-full" data-carousel="slide">
                <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
                    <div className="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="/uploads/berry.jpeg" className="absolute block max-w-full h-auto -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt=""/>
                    </div>
            ...
            <div className="grid grid-cols-1">
                <div className="flex justify-between gap-2 ...">
                    ...
                    <div className="flex justify-end ... gap my-auto">
        ...
        onActiveTabChange={(tab) => props.setActiveTab(tab)}>
            ...
            <Tabs.Item title="Gallery" icon={MdDashboard}>  
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2 ">
                    <div>
                        <img className="h-auto max-w-full rounded-lg" src="/uploads/berry.jpeg" alt="" onClick={() => props.setOpenModal('dismissible')}/>
                    </div>
                    <div>
                        <img className="h-auto max-w-full rounded-lg" src="/uploads/berry.jpeg" alt=""/>
                    </div>
                    <div>
                        <img className="h-auto max-w-full rounded-lg" src="/uploads/berry.jpeg" alt=""/>
                    </div>
